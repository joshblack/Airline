  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="/reservation" method="POST">
        ...
        <input type="text" class="form-control" name="phoneNumber" placeholder="Phone Number" required autofocus>
        <input type="hidden" class="form-control" name="tripNum" value="<?php echo $tripNum; ?>">
        <button class="btn btn-lg btn-primary btn-block" type="submit">Make Reservation</button>
      </form>
